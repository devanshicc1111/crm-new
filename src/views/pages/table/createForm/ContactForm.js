        ...
        >
          ...
          <Grid item xs={6} sx={{ marginTop: '0.3rem' }}>
            <TextField
              ...
              error={formik.touched.addNote && Boolean(formik.errors.addNote)}
              helperText={formik.touched.addNote && formik.errors.addNote}
            />
          </Grid>

          <Grid item xs={2} sx={{ marginTop: '0.3rem' }}>
            <div
              style={{
                display: 'flex',
                alignItems: 'center',
